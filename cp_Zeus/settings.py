"""
Django settings for cp_Zeus project.
...
SECRET_KEY = '24jvvm_7ef&3r0rfm$4xb*rp$j07p#99r$m5#0kzghcg!0d*=_'
...
WSGI_APPLICATION = 'cp_Zeus.wsgi.application'
